...
(function ($) {
  ...
  var Core = {
    ...
    SvgPolyfill: function SvgPolyfill() {
      svg4everybody();
    },
    ...
    headerNav: function headerNav() {
      ...
      if (mainNav.exists()) {
        var navList = $('.main-nav__list'),
            ...
            megaMenu = $('.main-nav__megamenu', navList); // Add toggle button and class if menu has submenu

        navListLi.has('.main-nav__sub').addClass('has-children').append('<span class="main-nav__toggle">&nbsp;</span>');
        navListLi.has('.main-nav__megamenu').addClass('has-children').append('<span class="main-nav__toggle">&nbsp;</span>'); // Add toggle button and class if submenu has sub-submenu
    ...
    mobileNav: function mobileNav() {
      ...
      if (mobileNav.exists()) {
        var navList = $('.mobile-nav__list'),
            navListLi = $('.mobile-nav__list > li'); // Add toggle button and class if menu has submenu
    ...
    headerMenuPanel: function headerMenuPanel() {
    ...
    headerBlogFilter: function headerBlogFilter() {
    ...
    checkoutRedeemPopup: function checkoutRedeemPopup() {
    ...
    isotope: function isotope() {
      ...
      if (streams.exists()) {
        ...
        isotopeGrid = streams.imagesLoaded(function () {
          ...
          isotopeGrid.isotope('layout'); // filter items on button click
      ...
      if (matches.exists()) {
        isotopeGrid = matches.imagesLoaded(function () {
          var $filter = $('.js-filter'); // init Isotope after all images have loaded

          isotopeGrid.isotope({
            // filter: '*',
            layoutMode: 'fitRows',
            itemSelector: '.col-md-12' // masonry: {
            // 	columnWidth: '.stream'
            // }
    ...
    slickCarousel: function slickCarousel() {
      var slick_widget_carousel = $('.widget-carousel'),
          ...
          slick_team_slider = $('.js-team-selection-slider'); // Team Slider
    ...
    socialGlitchEffect: function socialGlitchEffect() {
    ...
    miscScripts: function miscScripts() {
