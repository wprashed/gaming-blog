...
class maggie_Portfolio_Grid extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'maggie-portfolio-grid';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Portfolio Grid', 'maggie-core' );
	}
	...
	protected function render() {
		...
		<section class="maggie_project project_v2 section_padding" id="project">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
				...
				<div class="row grid_wrapper">
					<?php 
                        ...
                        $slug = implode(" ", $slugs); 
                    ?>
					<div class="col-lg-4 col-md-6 col-sm-12 single_project <?php echo esc_attr($slug); ?>">
						<?php else: ?>
	                    <?php endif; ?>
						<div class="grid_item">
