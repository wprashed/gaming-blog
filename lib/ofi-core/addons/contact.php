...
class maggie_Contact extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'maggie-contact';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Contact Us', 'maggie-core' );
	}
	...
	function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Get In Touch With Us', 'maggie-core' ),
			]
		);
	...
	protected function render() {
		...
		?>
		<section class="maggie_contact contact_v1">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="maggie_img_box">
							<img src="<?php echo $settings['side_image']['url'] ?>" class="img-fluid" alt="">
						</div>
					</div>
					<div class="col-lg-6">
